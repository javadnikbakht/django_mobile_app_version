...
import mobile_app_version.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(help_text='Version must follow semantic versioning format (X.Y.Z). Example: 1.0.0', max_length=100, validators=[mobile_app_version.validators.validate_semantic_version])),
